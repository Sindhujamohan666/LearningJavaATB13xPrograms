...
class GoodVWOLogin{
    ...
    public void setPassword(String password,boolean isAdmin) {
        /*if this condition is not given then anybody else can change password which is not right
        so using getter and setter methods we are implementing encapsulation
         */
        if(isAdmin) {
            this.password = password;
        }else {
