...
public class Task1 {
    public static void main(String[] args) {
        ...
        System.out.printf("%d*%d=%d",num,7,num*7).println();
        System.out.printf("%d*%d=%d",num,8,num*8).println();
        System.out.printf("%d*%d=%d",num,9,num*9).println();
        System.out.printf("%d*%d=%d",num,10,num*10).println();
        System.out.printf("%d*%d=%d",num,11,num*11).println();
        System.out.printf("%d*%d=%d",num,12,num*12).println();
    }
}
